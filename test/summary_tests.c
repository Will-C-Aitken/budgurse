...
*/
    ...
    mu_assert(g_summary->num_cols == 14, "Summary", 3);
    mu_assert(g_summary->x_start == 9, "Summary", 4);
    mu_assert(g_summary->x_sel == 13, "Summary", 5);
    mu_assert(g_summary->x_end == 13, "Summary", 6);
    mu_assert(g_summary->y_start == 4, "Summary", 7);
    ...
    mu_assert(g_summary->num_cols == 14, "Summary", 12);
    mu_assert(g_summary->x_start == 10, "Summary", 13);
    mu_assert(g_summary->x_sel == 13, "Summary", 14);
    mu_assert(g_summary->x_end == 13, "Summary", 15);
    mu_assert(g_summary->y_start == 0, "Summary", 16);
    mu_assert(g_summary->y_sel == 5, "Summary", 17);
    mu_assert(g_summary->y_end == 5, "Summary", 18);
    mu_assert(is_amount_eq(g_summary->data[0], 0.00), "Summary", 10);
    free_summary(g_summary);
